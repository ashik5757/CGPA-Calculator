...
//        setGrade(cbGrade6);
    ...
    void calculate(ActionEvent event) {
        ...
        CGPA cgpa = new CGPA(dataList.getCurrentProfile().getCgpa(),dataList.getCurrentProfile().getCreditCompleted());
    ...
    public void setLabel() {
        this.lbCurrentCGPA.setText("Current CGPA : " + dataList.getCurrentProfile().getCgpa());
        this.lbCurrentCredit.setText("Current Credit Completed : " + dataList.getCurrentProfile().getCreditCompleted());
    }
